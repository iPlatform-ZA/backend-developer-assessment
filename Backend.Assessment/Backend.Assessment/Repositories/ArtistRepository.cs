...
namespace Backend.Assessment.Repositories
{
    public class ArtistRepository : Repository<Artist>, IArtistRepository
    {
        ...
        public IEnumerable<Artist> SearchArtist(string criteria, int pageNumber, int pageSize = 5)
        {
            return BackendContext.Artists
                 .Where(a => a.Firstname.Contains(criteria) || a.Lastname.Contains(criteria));
        }
